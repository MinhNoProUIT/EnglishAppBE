const { mapGetAllCommentsByPostToVModel, mapCreateCommentsToVModel, mapEditCommentToVModel } = require("../mappings/CommentMapping");
...
const CommentController = {
  async getAllCommentsByPost(req, res) {
    try {
      const { id } = req.params;
      const allComments = await CommentService.getAllCommentsByPost(id);
